...
describe('PostFormComponent', () => {
  ...
  beforeEach(async () => {
    ...
    const FakeOktaAuthService  = {
      create(post: NewPost): Promise<NewPost>{return Promise.resolve(newPostObject); },
  ...
  it('should match between user id and getUserId function', () => {
    component = new PostFormComponent(TestBed.inject(UploadService), TestBed.inject(PostService), TestBed.inject(ProfileService));
    component.getUser();
